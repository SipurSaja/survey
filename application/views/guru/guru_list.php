            ...
            <div class="page-wrapper">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <form action="<?= base_url('dashboard/guru')?>" method="get">
                            ...
                            <?php }?>
                                ...
                                <?php foreach($guru as $g => $value){ ?>
                                    <tr>
                                        ...
                                        <td><center>
                                        <a href="<?= base_url('guru/detail/'. $value["id_guru"])?>" type="button" class="btn btn-sm btn-primary"><i class="ti-book"></i></a>
