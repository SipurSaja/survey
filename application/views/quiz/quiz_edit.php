        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body ">
                            <h4 class="card-title">Update quiz</h4>
                        </div>
                ...
                if (isset($error_up)) {
                  ...
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h5><i class="icon fas fa-ban"></i>'.$error_up.'</h5></div>';
                        ...
                        echo form_open_multipart('quiz/edit/'. $quiz->id_quiz) ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="quiz" type="text" class="form-control input-square"
                                            id="squareInput" placeholder="Masukkan quiz" value="<?= $quiz->quiz ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <option value=""><?= $quiz->nama_quiz ?></option>
