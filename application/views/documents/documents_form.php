            ...
            <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <form action="<?= base_url('dashboard/documents')?>" method="get">
...
<div class="modal fade" id="tambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('documents/add')?>" method="post" enctype="multipart/form-data">
...
<!-- Modal Edit -->
<?php foreach ($documents as $d => $value) { ?>
<div class="modal fade" id="edit<?= $value['id_file'] ?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('documents/edit/'. $value['id_file']) ?>
...
<div class="modal fade" id="hapus<?= $value['id_file'] ?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="<?= base_url('documents/delete/'. $value['id_file']) ?>" class="btn btn-primary">Delete</a>
            </div>
        </div>
    </div>
</div>
